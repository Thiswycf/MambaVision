"""
CUDA_VISIBLE_DEVICES=3 python nas/train_only_tiny.py -c nas/configs/only_tiny.yaml

CUDA_VISIBLE_DEVICES=4,5 torchrun --nproc_per_node=2 nas/train_only_tiny.py -c nas/configs/only_tiny.yaml

CUDA_VISIBLE_DEVICES=2,3,4,5 torchrun --nproc_per_node=4 nas/train_only_tiny.py -c nas/configs/only_tiny.yaml
